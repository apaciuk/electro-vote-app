...
ActiveRecord::Schema[7.0].define(version: 2022_10_15_221748) do
  ...
  create_table "ballot_prompt_choices", force: :cascade do |t|
    t.string "choice_text"
    t.bigint "ballot_prompt_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ballot_prompt_id"], name: "index_ballot_prompt_choices_on_ballot_prompt_id"
  end

  create_table "ballot_prompts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campaign_id"], name: "index_ballot_prompts_on_campaign_id"
  end
  ...
  create_table "ballots", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campaign_id"], name: "index_ballots_on_campaign_id"
  ...
  add_foreign_key "ballot_prompt_choices", "ballot_prompts"
  add_foreign_key "ballot_prompts", "campaigns"
  add_foreign_key "ballots", "campaigns"
